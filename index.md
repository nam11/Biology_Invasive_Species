...
<figcaption><b><i>Buffelgrass stalk with flower</b></i></figcaption>
...
CRISPR stands for Clustered Regularly Interspaced Short Palindromic Repeats. In short, CRISPR is a gene editing tool. CRISPR is still being developed and fine tuned; however, CRISPR has made significant scientific advancements and progress. It would be possible for scientists to use CRISPR to alter the genome of buffelgrass to make the buffelgrass more fire-resistant. There are multiple ways for CRISPR to edit an organism's DNA.
...
Finally, CRISPR can **silence** genes. Gene silencing is suppressing a specific trait from a particular gene.[6] Gene silencing could be used on the buffelgrass to silence the genes that cause the buffelgrass to be more flammable or more sensitive.
